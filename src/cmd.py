...
parser.add_argument( "-ev", "--espeak-voice", default = "en", const="", help = "Specifies the Espeak voice that the emulator will use. This should be given in language[-dialect]+[variant] format, (e. g.: en, en-us, en+max, en-us+max). Note that you can't use --espeak-voice and --sapi together.", dest="espeak")
